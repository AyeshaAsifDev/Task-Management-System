        ...
        <div className="flex h-screen flex-col items-center justify-center ">
            {/* <div className="items-center justify-center border-2 border-green-800 p-20 rounded px-7 1border-zinc-200"> */}
                <div className="w-[60vw] md:w-[50vw] lg:w-[30vw]">
                    ...
                    <h3 className="text-center font-semibold text-xinc-900">Register for the App</h3>
                </div>
                ...
                <div className="w-[60vw] md:w-[50vw] lg:w-[30vw] mt-4 ">
                    <form className="flex flex-col gap-4">
                        ...
                        <button className="bg-green-800 text-white font-semibold py-2 rounded hover:bg-green-800 transition-all duration-300" onClick={register}>
                          Signup
                        </button>
